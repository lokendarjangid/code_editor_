                ...
                {sortedParticipants.length === 0 ? (
                    ...
                    sortedParticipants.map((participant, index) => {
                        ...
                        return (
                            <div
                                key={participant.id}
                                className={`flex items-center justify-between p-2 lg:p-3 rounded-lg transition-all duration-200 ${isTopPerformer
                            ...
                            >
                                <div className="flex items-center space-x-2 lg:space-x-3 flex-1 min-w-0">
                                    ...
                                    <div className={`w-6 h-6 lg:w-8 lg:h-8 rounded-full flex items-center justify-center text-white text-xs lg:text-sm font-medium flex-shrink-0 ${isTopPerformer
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {isHost && participant.id !== hostId && onToggleParticipantEdit && (
                                        <button
                                            onClick={() => onToggleParticipantEdit(participant.id, !participant.canEdit)}
                                            className={`text-xs px-2 py-1 rounded transition-colors ${participant.canEdit
                                    ...
                                    <div className="text-right flex-shrink-0">
                                        <p className={`text-sm lg:text-base font-bold ${getScoreColor(participant.score)} ${isTopPerformer ? 'text-yellow-600 dark:text-yellow-400' : ''
                                            }`}>
                                            {participant.score}
                                        </p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400">
